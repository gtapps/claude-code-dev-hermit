...
- **Independent tasks** — use Agent Teams (experimental) or implement sequentially
...
- **After plugin updates**, run `/claude-code-dev-hermit:dev-hatch` to refresh the dev workflow block in CLAUDE.md.

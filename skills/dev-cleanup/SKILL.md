...
- Verify `.claude/.claude-code-hermit/sessions/` exists (core + dev hermit initialized)
...
3. Cross-reference with `.claude/.claude-code-hermit/sessions/SHELL.md`
   **and** all `S-*-REPORT.md` files in the sessions directory to
   ...
   Also check `.claude/.claude-code-hermit/sessions/NEXT-TASK.md` — if it
